...
// NewTCPClient ...
func NewTCPClient(name string, addr string, connCnt int, isAutoReconnect bool, autoReconnectInterval time.Duration, tcpConnWriteChanLen int, msgPackager msgpackager.MsgPackager, msgProcessor msgprocessor.MsgProcessor, newCrypto func() crypto.Crypto) *Client {
