...
func NewTCPServer(name string, addr string, maxConnCnt int, tcpConnWriteChanLen int, bCloseBuffFull bool, msgPackager msgpackager.MsgPackager, msgProcessor msgprocessor.MsgProcessor, newCrypto func() crypto.Crypto) *Server {
