...
func ListenMsgSugar(app iListenMsg, msgHandler interface{}) {
...
// msgHandler 必须是 func(sender Server, msg *FooMsg) 形式的函数.
func ListenSessionMsgSugar(app iListenSessionMsg, msgHandler interface{}) {
	v := reflect.ValueOf(msgHandler)
...
func ListenGateSessionMsgSugar(app iListenGateSessionMsg, msgHandler interface{}) {
	v := reflect.ValueOf(msgHandler)
