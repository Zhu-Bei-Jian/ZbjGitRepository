...
func (net *implMetaNet) Init(config *AppConfig, io ioservice.IOService) {
	if config == nil {
...
func (net *implMetaNet) ListenMessage(msg interface{}, fmessage OnNetMessage) {
	...
	handler := func(conn connection.Connection, ext interface{}, msgId uint32,msgData []byte,msg interface{}) {
...
func (net *implMetaNet) SendGateMsg(ID uint32, msg interface{}) error {
...
func (net *implMetaNet) SendMsg(ID uint32,  msg interface{},extend *Server_Extend) error {
	net.NetMutex.Lock()
	defer net.NetMutex.Unlock()
...
func (net *implMetaNet) onBytes(conn connection.Connection, ext interface{}, msgid uint32, bytes []byte) {
...
// TODO ServerStartTime 参数在这里应该是无用的,
// 因为一个有效的服务节点始终只可能有一个连接对象对应, 如果有两个连接对象同时指向一个服务节点对象，则说明状态维护已经出问题了
